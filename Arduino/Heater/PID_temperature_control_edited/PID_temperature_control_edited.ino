...
//Variables
float set_temperature = 150;            //Default temperature setpoint. Leave it 0 and control it with rotary encoder
...
//using MAX6675 Library
#define SO_PIN  12  // 6675 Serial Output
#define CS_PIN  10  // 6675 Chip Select
#define CK_PIN  13  // 6675 Clock Pin
